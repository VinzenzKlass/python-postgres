export default function (hljs) {
    ...
    return {
        ...
        contains: [
            ...
            {
                className: 'string',
                begin: /(["'])(\s*)(SELECT|INSERT|UPDATE|DELETE|CREATE|ALTER|DROP|TRUNCATE)\b/,
                end:/(["'])/,
                contains: [
                    {
                        className: 'keyword',
                        begin: /SELECT|INSERT|UPDATE|DELETE|CREATE|ALTER|DROP|TRUNCATE/,
                    },
                    {
                        className: 'keyword',
                        begin: '\\b(?:' + PG_KW.trim().replace(/ /g, '|') + ')\\b',
                    },
                    {
                        className: 'type',
                        begin: '\\b(?:' + PG_TYPES.trim().replace(/ /g, '|') + ')\\b',
                    },
                    {
                        className: 'built_in',
                        begin: '\\b(?:' + PG_FUNCTIONS.trim().replace(/ /g, '|') + ')\\b',
                    },
                ],
            },
            STRING,
